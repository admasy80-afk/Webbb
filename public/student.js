...
async function fetchDashboardData() {
    try {
        ...
        if (res.ok) {
            ...
            // باقي التحديثات (النقاط، المقالي، الورقي) بقيت كما هي لمنع كسر أي منطق
            // ... (نفس الكود الخاص بـ pointsContainer, questionsContainer, testsContainer)
            // تم اختصارها هنا لتجنب التكرار البصري، وهي مطابقة تماماً لكودك الأصلي
