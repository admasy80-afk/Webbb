...
const backupQuestions = [
    ...
    {"questionText":"«شعور الأغنياء بالثراء يدفعهم أحيانًا للقفز على السلطة والوصول للحكم». تنطبق العبارة السابقة بشكل واضح على مجتمعي ............ ","options":["أثينا وروما.","إسبرطة ومقدونيا.","فينقييا وقرطاجة.","العراق وكريت."],"correctAnswer":2},
    ...
    {"questionText":"يشير النص المقابل (هادريان في زيارة لمصر) إلى ............ ","options":["الوفاء والصبر.","الإخلاص والبناء.","التدين والمحبة.","العمل والتأسيس."],"correctAnswer":1},
    ...
    try {
        const res = await fetch('/api/admin/add-public-quiz', {
            ...
            body: JSON.stringify({ 
                ...
                quizTitle: isForced ? "الاختبار الشامل المعتمد (جاهز)" : document.getElementById('publicQuizTitle').value, 
